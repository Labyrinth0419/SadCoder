...
const builtInSlashCommands = <SlashCommandSpec>[
  ...
  SlashCommandSpec(
    ...
    mappingType: SlashCommandMappingType.appServer,
    mappingTarget: 'windowsSandbox/setupStart elevated',
    phase: SlashCommandPhase.thirdStage,
  ...
  SlashCommandSpec(
    ...
    availableDuringTask: false,
    mappingType: SlashCommandMappingType.appServer,
    mappingTarget: 'experimentalFeature/list + config/batchWrite',
    phase: SlashCommandPhase.thirdStage,
  ...
  SlashCommandSpec(
    ...
    availableDuringTask: false,
    mappingType: SlashCommandMappingType.appServer,
    mappingTarget: 'thread/memoryMode/set + memory/reset',
    phase: SlashCommandPhase.thirdStage,
    riskLevel: SlashCommandRiskLevel.medium,
  ),
  SlashCommandSpec(
  ...
  SlashCommandSpec(
    ...
    availableDuringTask: false,
    mappingType: SlashCommandMappingType.appServer,
    mappingTarget: 'turn/start with AGENTS.md file-change approval',
    phase: SlashCommandPhase.thirdStage,
    riskLevel: SlashCommandRiskLevel.medium,
  ),
  SlashCommandSpec(
  ...
  SlashCommandSpec(
    command: 'mcp',
    description:
        'list configured MCP tools; use /mcp verbose, reload, or login <server>',
    supportsInlineArgs: true,
    mappingType: SlashCommandMappingType.appServer,
    mappingTarget:
  ...
  SlashCommandSpec(
    command: 'plugins',
    description:
        'browse plugins; manage plugin installs and marketplace sources',
    supportsInlineArgs: true,
    mappingType: SlashCommandMappingType.appServer,
    mappingTarget:
        'plugin/list/install/uninstall + marketplace/add/remove/upgrade',
    phase: SlashCommandPhase.secondStage,
    riskLevel: SlashCommandRiskLevel.medium,
  ),
  SlashCommandSpec(
